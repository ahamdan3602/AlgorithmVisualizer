import { sleep } from "./helpers/column.js";
import { SortingAlgo } from "./helpers/sortingAlgorithms.js";
...
const selectAlgo = document.getElementById('selectAlgorithm');
...
const sortingAlgorithms = new SortingAlgo({});
...
start();
    ...
    async function swapBars(barsDivs, i, j) {
        ...
        barsDivs[j].style.left = `${5+j*30}px`;
